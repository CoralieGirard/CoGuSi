<div class="card mb-4">
  ...
  if(isset($_SESSION["userID"]) && $Proprietaire == $_SESSION["userID"]){
    ...
    <form method = 'post' action = 'DOMAINLOGIC/editCommentaire.dom.php'>

      <div class='form-group'>
        <input type='hidden' name='idCommentaire' value='$idCommentaire'>
        <textarea rows='5' name='contenu' id='contenu' placeholder='Got something wrong, punk?' required></textarea>
